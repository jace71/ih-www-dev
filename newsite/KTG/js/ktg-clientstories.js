$(document).ready(function() {
    ...
    $('#ih-page-header').append('<div class="row"><div class="col-md-12"><ul class="ktg-nav"><li><a href="/knowledge-to-go">All</a></li><li><a href="/white-papers">White Papers</a></li><li><a href="/blog">Blog Posts</a></li><li><a href="/client-stories" class="selected">Client Story <i class="fa fa-chevron-down"></i></a></li><li><a href="/infographics">Infographics</a></li><li><a href="/webinars">Webinars</a></li></ul></div></div>');

    $('.ih-header-column').append('<ul class="ktg-nav-mobile"><li><a href="/knowledge-to-go">All</a></li><li><a href="/white-papers">White Papers</a></li><li><a href="/blog">Blog Posts</a></li><li class="selected"><a class="selected" href="/client-stories">Client Story</a></li><li><a href="/infographics">Infographics</a></li><li><a href="/webinars">Webinars</a></li></ul>');
    ...
    $('.view-more').on('click',function(e){
        ...
        $('#resultsWrapper_ktg-clientstories-row > div').slice(numVisible, numVisible + numToAdd).fadeIn(800);

        console.log('slideDown fired');
        var pageTop = $(window).scrollTop();
        console.log(pageTop);
        $('html,body').stop().animate({
            scrollTop: ($('#resultsWrapper_ktg-clientstories-row > div:nth-child(' + numVisible + ')').offset().top +350)
        }, 600);
    ...
    function addRow() {
        ...
        $('#resultsWrapper_ktg-clientstories-row > div').slice(numVisible, numVisible + numToAdd).fadeIn(800, function(){
            var numDuration = ($('.landing-featured').height() + $('.landing-pg-row').height() - 200);
            scene.duration(numDuration);    
        });
