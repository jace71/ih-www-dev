$(document).ready(function() {
    ...
    $('#ih-page-header').append('<div class="row"><div class="col-md-12"><ul class="ktg-nav"><li><a href="/knowledge-to-go">All</a></li><li><a href="/white-papers">White Papers</a></li><li><a href="/blog" class="selected">Blog Posts <i class="fa fa-chevron-down"></i></a></li><li><a href="/client-stories">Client Story</a></li><li><a href="/infographics">Infographics</a></li><li><a href="/webinars">Webinars</a></li></ul></div></div>');

    $('.ih-header-column').append('<ul class="ktg-nav-mobile"><li><a href="/knowledge-to-go">All</a></li><li><a href="/white-papers">White Papers</a></li><li class="selected"><a class="selected" href="/blog">Blog Posts</a></li><li><a href="/client-stories">Client Story</a></li><li><a href="/infographics">Infographics</a></li><li><a href="/webinars">Webinars</a></li></ul>');
    ...
    //$('.landing-pg-row .row.feed').append('<div class="btn-holder"><a href="#" class="btn view-more-btn view-more">View More</a></div>');
    ...
    $('.view-more').on('click',function(e){
        ...
        $('#resultsWrapper_ktg-blog-row > div').slice(numVisible, numVisible + numToAdd).fadeIn(800);
            
        console.log('slideDown fired');
        var pageTop = $(window).scrollTop();
        console.log(pageTop);
        $('html,body').stop().animate({
            scrollTop: ($('#resultsWrapper_ktg-blog-row > div:nth-child(' + numVisible + ')').offset().top +350)
        }, 600);
    ...
    contentquery.search('ktg-blog-featured', 
    'custom_s_content_type:("Blog") AND custom_b_featured:true AND !custom_b_archived:true&sort=custom_dt_publish_date_226894+desc,title+asc', 
    ...
    // blog row
    if ($(window).width() > 768) {
        contentRowQuery('ktg-blog-row', 'Blog', 204);
    } else {
        contentRowQuery('ktg-blog-row', 'Blog', 111);
    }
    $(window).load(function(){
        $('#resultsWrapper_ktg-blog-row > div:lt(6)').show();
    });
    ...
    function contentRowQuery(contentHolder, contentType, numEntries) {
        ...
        'custom_s_content_type:("' + contentType + '") AND !custom_b_featured:true AND (custom_dt_publish_date_226894:([* TO ' + currentDate.getFullYear() + '\\-' + (currentDate.getMonth() + 1) + '\\-' + currentDate.getDate() + 'T00\:00\:00.000Z])) AND !custom_b_archived:true&rows=3&start=9&sort=custom_dt_publish_date_226894+desc,title+asc', '&lt;div class=&quot;col-md-4 col-sm-6 col-xs-6&quot;&gt;                    &lt;div class=&quot;card&quot;&gt; &lt;a href=&quot;{custom_s_url}&quot;&gt; &lt;div class=&quot;text-holder&quot;&gt; &lt;div class=&quot;card-bg-holder&quot; style=&#39;background-image: url(&quot;{custom_s_thumbnail_image}&quot;);&#39;&gt;&lt;/div&gt; &lt;div class=&quot;text&quot;&gt;                                    &lt;div class=&quot;type&quot;&gt;{custom_s_content_type}&lt;/div&gt;                                    &lt;div class=&quot;pubdate&quot;&gt;{custom_dt_publish_date_226894} &lt;span class=&quot;reading-time&quot;&gt; &lt;i&gt;|&lt;/i&gt; &lt;span&gt;{custom_d_word_count_238538}&lt;/span&gt; min. read&lt;/span&gt; &lt;/div&gt;                                    &lt;div class=&quot;title-holder&quot;&gt;                                        &lt;h3&gt;{title}&lt;/h3&gt;                                    &lt;/div&gt;                                &lt;/div&gt;                            &lt;/div&gt;                        &lt;/a&gt;                    &lt;/div&gt;                &lt;/div&gt;', 
        numEntries, 
        '');
    }

    function insertEmailSignupCard(){
        $('#customList > div > div:nth-child(6)').hide();
        $('#customList > div > div:nth-child(3)').after('<div class="col-md-4 col-sm-6 col-xs-6" style="display:block;"><div class="card sign-up"><div class="text-holder"><div class="emphasis">Like Our Content?<br>Join Our Mailing List!</div><div class="newsletter-title">Newsletter<br/>Signup</div><div class="text"><div class="title-holder"><iframe src="https://go.pardot.com/l/34402/2018-02-28/xngq2h" width="100%" height="100" type="text/html" frameborder="0" allowTransparency="true" style="border: 0"></iframe></div></div></div></div></div>');
    }
    ...
    function addRow() {
        ...
        $('#resultsWrapper_ktg-blog-row > div').slice(numVisible, numVisible + numToAdd).fadeIn(800, function(){
            var numDuration = ($('.landing-featured').height() + $('.landing-pg-row').height() - 200);
            scene.duration(numDuration);    
        });
